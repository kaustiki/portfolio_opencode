...
export default function Contact() {
  ...
  return (
    <Section id="contact" title="Get In Touch" className="bg-background/60 backdrop-blur-sm">
        ...
        >
          {submitted ? (
            <Card className="text-center py-12">
              ...
              <p className="text-text">Thank you for reaching out. I&apos;ll get back to you soon.</p>
            </Card>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  name="name"
                  required
                  className="w-full px-4 py-3 border border-border rounded-md bg-background text-text placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition-all"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 border border-border rounded-md bg-background text-text placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition-all resize-none"
